  ...
  container.innerHTML = banners.map((b, i) => `
    <div class="promo-slide${i === 0 ? ' active' : ''}" style="background:${b.gradient}" onclick="openPromoDetail(${i})">
      <div class="promo-image-wrap">
        <img src="${b.image}" alt="${b.text}" loading="lazy" onerror="this.parentElement.innerHTML='<div style=&quot;width:100%;height:100%;display:flex;align-items:center;justify-content:center;font-size:48px;opacity:.3&quot;><i class=&quot;fas fa-paw&quot;></i></div>'">
      </div>
